...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=192.168.31.93;Initial Catalog=FUNShare;User ID=FUNShareDB;Password=987654321");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AchievementList>(entity =>
        {
            ...
            entity.HasOne(d => d.Achievement).WithMany(p => p.AchievementList)
        ...
        modelBuilder.Entity<AdvertiseOrder>(entity =>
        {
            ...
            entity.HasOne(d => d.Package).WithMany(p => p.AdvertiseOrder)
                .HasForeignKey(d => d.PackageId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Advertise_Order_Advertise_Product");

            entity.HasOne(d => d.Supplier).WithMany(p => p.AdvertiseOrder)
        ...
        modelBuilder.Entity<AdvertiseProductDetail>(entity =>
        {
            ...
            entity.HasOne(d => d.Package).WithMany(p => p.AdvertiseProductDetail)
                .HasForeignKey(d => d.PackageId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Advertise_Product_Detail_Advertise_Product");

            entity.HasOne(d => d.Product).WithMany(p => p.AdvertiseProductDetail)
                .HasForeignKey(d => d.ProductId)
        ...
        modelBuilder.Entity<Bonus>(entity =>
        {
            ...
            entity.HasOne(d => d.Member).WithMany(p => p.Bonus)
                .HasForeignKey(d => d.MemberId)
                .HasConstraintName("FK_Bonus_Customer_Infomation");

            entity.HasOne(d => d.Order).WithMany(p => p.Bonus)
        ...
        {
            entity.HasKey(e => e.CouponId).HasName("PK_CouponList");
        ...
        modelBuilder.Entity<Interest>(entity =>
        {
            ...
            entity.HasOne(d => d.Member).WithMany(p => p.Interest)
                .HasForeignKey(d => d.MemberId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Interest_Customer_Infomation");

            entity.HasOne(d => d.SubCategory).WithMany(p => p.Interest)
        ...
        {
            entity.HasKey(e => e.IntervalId).HasName("PK__Table__EB97C1EE7D0DBB26");
        ...
        {
            entity.HasKey(e => e.LoginId).HasName("PK_LoginLog");
        ...
        modelBuilder.Entity<MemberAchievement>(entity =>
        {
            ...
            entity.HasOne(d => d.Achievement).WithMany(p => p.MemberAchievement)
                .HasForeignKey(d => d.AchievementId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_MemberAchievement_Achievement");

            entity.HasOne(d => d.Member).WithMany(p => p.MemberAchievement)
                .HasForeignKey(d => d.MemberId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<MemberCoupon>(entity =>
        {
            ...
            entity.HasOne(d => d.Coupon).WithMany(p => p.MemberCoupon)
                .HasForeignKey(d => d.CouponId)
                .HasConstraintName("FK_Member_Coupon_Coupon_List");

            entity.HasOne(d => d.Member).WithMany(p => p.MemberCoupon)
                .HasForeignKey(d => d.MemberId)
        ...
        modelBuilder.Entity<OrderDetail>(entity =>
        {
            ...
            entity.HasOne(d => d.Status).WithMany(p => p.OrderDetail)
                .HasForeignKey(d => d.StatusId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.PocketlistId).HasName("PK_PocketList");
            ...
            entity.HasOne(d => d.Member).WithMany(p => p.PocketList)
                .HasForeignKey(d => d.MemberId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_PocketList_Customer_Infomation");

            entity.HasOne(d => d.Product).WithMany(p => p.PocketList)
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<ProductDetail>(entity =>
        {
            ...
            entity.HasOne(d => d.Status).WithMany(p => p.ProductDetail)
                .HasForeignKey(d => d.StatusId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Supplier>(entity =>
        {
            ...
            entity.HasOne(d => d.Status).WithMany(p => p.Supplier)
                .HasForeignKey(d => d.StatusId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Survey>(entity =>
        {
            ...
            entity.HasOne(d => d.Member).WithMany(p => p.Survey)
                .HasForeignKey(d => d.MemberId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Survey_Customer_Infomation");

            entity.HasOne(d => d.OrderDetail).WithMany(p => p.Survey)
